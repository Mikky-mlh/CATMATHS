    ...
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [
          {
            role: 'system',
            content: 'You are a CAT exam question generator. You MUST respond with ONLY valid JSON. No explanations, no markdown, no code blocks. CRITICAL: Use proper LaTeX with backslashes: \\frac NOT frac, \\sqrt NOT sqrt, \\pi NOT pi.',
          },
          {
            role: 'user',
            content: prompt,
