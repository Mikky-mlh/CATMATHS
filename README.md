...
[![Tech Stack](https://img.shields.io/badge/Stack-React%2019%20%2B%20Vite-61DAFB?style=for-the-badge&logo=react)](https://react.dev/)
[![Styling](https://img.shields.io/badge/Styling-Tailwind%20v4-38B2AC?style=for-the-badge&logo=tailwind-css)](https://tailwindcss.com/)
...
- **Framework**: [React 19](https://react.dev/) (Concurrent rendering features)
- **Styling**: [Tailwind CSS v4](https://tailwindcss.com/) (New `@theme` directive architecture)
- **State**: [Zustand](https://zustand-demo.pmnd.rs/) (Lightweight progress persistence)
- **Math**: [KaTeX](https://katex.org/) (High-performance formula rendering)
- **Icons**: [Lucide React](https://lucide.dev/) (Crisp, semantic iconography)
- **AI**: [Groq Cloud API](https://groq.com/) (Llama 3.3 70B model)
