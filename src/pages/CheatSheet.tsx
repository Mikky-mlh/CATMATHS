...
// Section color config using module accent tokens
const sectionStyles = [
  { label: '1. Arithmetic (~35-40% of QA)', color: 'text-mod-arithmetic', border: 'border-mod-arithmetic' },
  { label: '2. Algebra (~20-25%)', color: 'text-mod-algebra', border: 'border-mod-algebra' },
  { label: '3. Number Systems (~10-15%)', color: 'text-mod-numbers', border: 'border-mod-numbers' },
  { label: '4. Geometry & Mensuration (~15-20%)', color: 'text-mod-geometry', border: 'border-mod-geometry' },
  { label: '5. Modern Math (~10-15%)', color: 'text-mod-modern', border: 'border-mod-modern' },
];
  ...
  return (
    <div className="max-w-4xl mx-auto pb-12">
      ...
      <div className="flex flex-col sm:flex-row items-center justify-between gap-4 mb-8 print:hidden">
        <Link
          to="/"
          className="flex items-center gap-2 text-ink-muted hover:text-primary transition-colors font-body font-medium text-sm"
        >
      ...
      {/* --- Main Sheet --- */}
      <div className="card p-8 md:p-12 print:shadow-none print:border-none print:p-0">
        {/* Title */}
        <div className="text-center mb-12 border-b-2 border-line pb-8">
          <h1 className="font-display text-3xl md:text-4xl text-ink mb-3">
            CAT Quant Cheat Sheet
          </h1>
          <p className="text-ink-secondary font-body text-md">
        ...
        <div className="space-y-12">
          ...
          <section>
            <h2 className={`text-xl font-display ${sectionStyles[0].color} border-b ${sectionStyles[0].border} pb-2 mb-6 uppercase tracking-[0.08em]`}>
              {sectionStyles[0].label}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <FormulaCard title="Percentages">
                <li><strong>Successive Change:</strong> <InlineMath math="a + b + \frac{ab}{100}" /></li>
                <li className="text-xs text-ink-muted italic">Trigger: Two back-to-back % changes on same base</li>
                <li><strong>% Change:</strong> <InlineMath math="\frac{\text{New} - \text{Old}}{\text{Old}} \times 100" /></li>
              </FormulaCard>

              <FormulaCard title="Profit & Loss">
                ...
                <li className="text-xs text-ink-muted italic">Trigger: When MP, CP, Profit%, Discount% are mixed</li>
              </FormulaCard>

              <FormulaCard title="Interest">
                ...
                <li className="text-xs text-ink-muted italic">Trigger: "Difference between CI and SI for 2 years" — use directly</li>
              </FormulaCard>

              <FormulaCard title="Time, Speed & Distance">
              ...
              <FormulaCard title="Ratios & Proportions">
                ...
                <li className="text-xs text-ink-muted italic">Trigger: Complex ratio equations</li>
              </FormulaCard>

              <FormulaCard title="Averages & Alligations">
                ...
                <li className="text-xs text-ink-muted italic">Trigger: Mixing two things at different prices/concentrations</li>
              </FormulaCard>

              <div className="md:col-span-2">
                <FormulaCard title="Time & Work">
                  ...
                  <li className="text-xs text-ink-muted italic">Trigger: Any work problem — LCM method avoids fractions entirely</li>
                </FormulaCard>
              </div>
            </div>
          </section>
          ...
          {/* ===== SECTION 2: ALGEBRA ===== */}
          <section>
            <h2 className={`text-xl font-display ${sectionStyles[1].color} border-b ${sectionStyles[1].border} pb-2 mb-6 uppercase tracking-[0.08em]`}>
              {sectionStyles[1].label}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <FormulaCard title="Quadratic Equations">
                <li className="text-ink-muted text-xs mb-1">For <InlineMath math="ax^2 + bx + c = 0" />:</li>
              ...
              <FormulaCard title="Key Identities">
                ...
                <li className="text-xs text-ink-muted italic">When a+b+c=0: a³+b³+c³ = 3abc</li>
              </FormulaCard>

              <FormulaCard title="Inequalities & Modulus">
          ...
          <section>
            <h2 className={`text-xl font-display ${sectionStyles[2].color} border-b ${sectionStyles[2].border} pb-2 mb-6 uppercase tracking-[0.08em]`}>
              {sectionStyles[2].label}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <FormulaCard title="Factors & Multiples">
                <li className="text-ink-muted text-xs mb-1">For <InlineMath math="N = a^p b^q c^r" />:</li>
                ...
                <li className="text-xs text-ink-muted italic">Trigger: "How many zeros at the end of n!"</li>
              </FormulaCard>

              <FormulaCard title="Remainders & Cyclicity">
                ...
                <li className="text-xs text-ink-muted italic">Find cycle by computing first few powers.</li>
              </FormulaCard>
            </div>
          </section>
          ...
          {/* ===== SECTION 4: GEOMETRY ===== */}
          <section>
            <h2 className={`text-xl font-display ${sectionStyles[3].color} border-b ${sectionStyles[3].border} pb-2 mb-6 uppercase tracking-[0.08em]`}>
              {sectionStyles[3].label}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <FormulaCard title="Triangles & Circles">
              ...
              <FormulaCard title="Polygons & 3D Shapes">
                ...
                <li className="text-xs text-ink-muted italic">Scaling: dimensions ×k → area ×k², volume ×k³</li>
              </FormulaCard>
            </div>
          </section>
          ...
          <section>
            <h2 className={`text-xl font-display ${sectionStyles[4].color} border-b ${sectionStyles[4].border} pb-2 mb-6 uppercase tracking-[0.08em]`}>
              {sectionStyles[4].label}
            </h2>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
              <FormulaCard title="P&C and Probability">
              ...
              <FormulaCard title="Progressions & Sets">
...
function FormulaCard({ title, children }: { title: string; children: React.ReactNode }) {
  return (
    <div className="p-5 bg-surface-alt rounded-xl border border-line-light">
      <h3 className="font-display text-lg text-ink mb-3">{title}</h3>
      <ul className="space-y-2.5 text-sm font-body text-ink-secondary">
        {children}
      </ul>
    </div>
  );
